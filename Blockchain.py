...
class Block:
    ...
    def calculate_hash(self) -> str:
        return self.SHA256_block_hash()

    def mine_block(self, difficulty_prefix: str = "000000") -> str:
...
class Blockchain:
    def __init__(self, difficulty_prefix: str = "000000"):
        self.chain = []
    ...
    def add_block(self, transactions: List[Transaction]) -> Block:
        ...
        block.mine_block(self.difficulty_prefix)
